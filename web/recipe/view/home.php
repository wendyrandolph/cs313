        ...
        <div class="card sm med lg xl">
            <div class="card-body">
                ...
                if (!isset($results)) {
                    ...
                    echo "<img src='../recipe/images/rsz_salsa.jpg' class='rounded .img-thumbnail container-fluid sm med lg xl'>";
                    echo "<img src='../recipe/images/rsz_idaho_burrito.jpg' class='rounded .img-thumbnail container-fluid sm med lg xl'>";
                    echo "</div>";
                } else { ?>

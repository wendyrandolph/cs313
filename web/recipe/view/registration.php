...
<div id="register_2">
        <h2 id=register_1>Register for an account</h2>
            ...
            <form action="/recipe/accounts/index.php/?action=register" method="post" >
                ...
                <input type="text" class="input" name="member_last_name" <?php if(isset($member_last_name)){echo "value='$member_last_name'";} ?> required><br><br>
                <label >Email:</label><br>
                <input type="email" class="input" name="member_email" <?php if(isset($member_email)){echo "value='$member_email'";} ?> required><br><br>
